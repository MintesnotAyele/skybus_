...
<div>      
  ...
  <h1 className="body-tile-h1">
    tired of a busy life ???
  </h1>
  <p className="parabody">
    take a break &amp; <br />a relax tour...
  </p>
  <a className="link-for-page" style={{ textDecoration: 'none' }}>
    <button className="get-started-with-us">
      get started with us
    </button>
  </a>
</div>
...
<div className="service-container">
  <div className="service-box-single-item">
    <h3 className="service-title">HAGERE</h3>
  </div>
  <div className="service-box-single-item">
    <h3 className="service-title">SKY</h3>
  </div>
  <div className="service-box-single-item">
    <h3 className="service-title">HAGERE</h3>
  </div>
  <div className="service-box-single-item">
    <h3 className="service-title">TATA</h3>
...
<div className=" px-2 py-12">
  <div id="features" className="mx-auto max-w-6xl ">
    ...
    <h2 className="text-center font-display text-4xl font-bold tracking-tight text-blue-200 md:text-4xl">
      Writing has never been so easy
    </h2>
    <ul className="mt-16 grid grid-cols-1 gap-6 text-center text-slate-700 md:grid-cols-3">
      <li className="rounded-xl bg-white px-6 py-8 shadow-sm">
        <img src="https://cdn.pixabay.com/photo/2016/12/18/12/49/cyber-security-1915628_1280.png" alt="" className="mx-auto h-10 w-10" />
        <h3 className="my-3 font-display font-medium">security</h3>
        ...
        <div
            ...
            <div class="overflow-hidden bg-orange-100 shadow-md rounded-xl">
                <div class="p-9"><svg class="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                    ...
                    <p class="mt-6 text-base text-blue-600">Go back and forth your history of changes and
