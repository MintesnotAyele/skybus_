...
<div>      
        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="flex items-center lg:order-2">
                <a href="#" class="text-slate-900 dark:text-white bg-sky-400 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-stone-400 focus:outline-none dark:focus:ring-gray-800"><Link to="/login">Login</Link></a>
                <a href="#" class="text-white bg-primary-700 hover:bg-sky-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 bg-stone-700 focus:outline-none dark:focus:ring-primary-800">Partners</a>
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"><Link to="/admins/aboutus">Aboutus</Link></a>
                    </li>
                    <li>
    ...
    <div className="content">
          ...
          Make Your Bus Booking Smoother With Wolkite Bus Station.  
           convenient and user-friendly bus booking website! 
