  ...
  return (
    <div className="min-h-screen p-6 bg-orange-100 flex items-center justify-center">
      <div className="container max-w-screen-lg mx-auto">
        <div>
          <h2 className="font-bold text-4xl text-slate-950">Register Bus</h2>

          <div className="bg-gray-200 rounded shadow-lg p-4 px-4 md:p-8 mb-6">
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
              <div className="text-gray-600">
                <p className="font-bold text-2xl text-slate-950">Bus Details</p>
                <p className="text-slate-950">Please fill out all the fields.</p>
              </div>
                ...
                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                  ...
                  <div className="md:col-span-5 text-right">
                    <div className="inline-flex items-end">
                      <button onClick={handleSubmit} className="bg-slate-800 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded">Submit</button>
                    </div>
                  </div>
                </div>
              </div>
